...
* 
* Copyright (C) 2019 Jack Ma (majian699@163.com)
*
...
static unsigned int globalfifo_poll(struct file *flip, poll_table *wait)
{
    unsigned int mask = 0;
    ...
    poll_wait(flip,&dev->w_wait,wait);
...
static int __init globalfifo_init(void)
{
    ...
    if (globalfifo_major)
    {
        ...
        printk(KERN_INFO "DO register_chrdev_region");
    }
    else
    {
        ...
        printk(KERN_INFO "DO alloc_chrdev_region");
    }
    if (ret < 0)
        return ret;
